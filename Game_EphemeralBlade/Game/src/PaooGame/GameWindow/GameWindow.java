...
public class GameWindow
{
    ...
    private MouseClick mouseClick;         /*!< Preia click-ul de la mouse*/
    ...
    /*! \fn GameWindow(String title, int width, int height)
         ...
         */
    public GameWindow(String title, int width, int height, KeyHandler kh, MouseClick ml){
    ...
    public void BuildGameWindow()
    {
        ...
        wndFrame = new JFrame(wndTitle);
            /// Se creaza un KeyHandler pt a prelua inputul de la tastatura
